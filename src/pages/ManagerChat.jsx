...
export default function ManagerChat() {
  ...
  const handlePinMessage = async (message) => {
    try {
      await chatAPI.pinMessage(message._id, !message.isPinned);
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-semibold text-gray-900 dark:text-white">Team Chat</h1>
        <p className="text-gray-600 dark:text-gray-300 mt-1">Communicate with your team members</p>
      </div>
            ...
            <div className="overflow-y-auto h-full">
              ...
              >
                ...
                <div className="flex-1 text-left">
                  <p className="font-medium text-gray-900 dark:text-white">Team Group Chat</p>
                  <p className="text-xs text-gray-500 dark:text-gray-400">Everyone in your team</p>
                </div>
